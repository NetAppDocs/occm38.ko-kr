...
** link:concept_monitoring.html["모니터링에 대해 자세히 알아보십시오"].
...
+
image:screenshot_cvo_licensing_aws.gif["라이선스 페이지의 스크린샷. Cloud Volumes ONTAP 버전, 라이센스(Explore, Standard 또는 Premium) 및 인스턴스 유형이 표시됩니다."]
...
+
link:concept_data_tiering.html["데이터 계층화의 작동 방식에 대해 알아보십시오"].
...
+
** link:concept_cloud_compliance.html["클라우드 규정 준수 에 대해 자세히 알아보십시오"].
** link:task_backup_to_s3.html["클라우드 백업에 대해 자세히 알아보십시오"].
** link:concept_monitoring.html["모니터링에 대해 자세히 알아보십시오"].
