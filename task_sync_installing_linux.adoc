...
.단계
. 을 사용하여 IAM 정책을 생성합니다 https://s3.amazonaws.com/metadata.datafabric.io/docs/on_prem_iam_policy.json["NetApp에서 제공하는 정책입니다"^]. https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_create.html["AWS 지침을 확인하십시오"^].
